...
import { type GovernEngine, govern } from "../../src/govern.js";
...
function makeTmpVault(): string {
	const dir = join(tmpdir(), `govern-fm-test-${randomUUID()}`);
...
function makeMockEngine(overrides?: Partial<GovernEngine>): GovernEngine {
	return {
